...
<!-- CSS used to setup the login box style. -->
<style>
.login-form {
    width: 340px;
    margin: 50px auto;
...
<!-- Login form with the variables necessary for recogniton from database. -->
</head>
<body>
<div class="login-form">
    <form action="" method="post">
        ...
        <div class="form-group">
            <a class="btn btn-primary btn-block" href="signin.php">Sign In</a>
        </div>                
    </form>

<!-- Connection with database + select function that will validate data and proceed to home page. -->
    <?php
